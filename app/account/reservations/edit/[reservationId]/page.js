...
export default async function Page({ params }) {
  ...
  return (
    <div>
      ...
      >
        {/* We do this so the reservation id is attached to the form data. Because the supabase update api will need it which executed on the updateReservationAction fn */}
